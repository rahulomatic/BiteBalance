...
class Sabbot:
    ...
    def get_default_responses(self):
        ...
        return {
            ...
            "food_queries": {
    "patterns": ["can i eat", "is it okay to eat", "safe to eat", "should i eat"],
    "responses": [
        "That's a good question! Generally, {food} can be included in your diet, but it depends on your condition. Would you like me to check it based on your profile?",
        "Let me check the nutrition facts for {food} and see if it fits your dietary needs.",
        "It depends! Some foods like {food} are healthy in general, but may not be suitable for certain conditions like {condition}."
    ]
},
    "nutrition_facts": {
        "patterns": ["how much protein", "how many calories", "what nutrients", "carbs in", "fat in"],
        "responses": [
            "{food} contains approximately {protein}g protein, {carbs}g carbohydrates, and {calories} kcal per 100g.",
            "Let me break it down for you: In 100g of {food}, you get {nutrients}."
        ]
    },
    "special_diets": {
        "patterns": ["gluten-free", "vegetarian", "vegan", "intermittent fasting"],
        "responses": [
            "For a gluten-free diet, avoid wheat, barley, and rye. Try quinoa, rice, and buckwheat instead.",
            "Vegetarian diets can be very healthy – include beans, lentils, dairy (if not vegan), tofu, nuts, and lots of veggies!",
            "During intermittent fasting, make sure your eating window includes balanced meals to prevent nutrient loss."
        ]
    },
    "lifecycle_nutrition": {
        "patterns": ["pregnancy", "child nutrition", "elderly", "infant"],
        "responses": [
            "During pregnancy, focus on folate, iron, calcium, and protein. Avoid unpasteurized foods and raw fish.",
            "For children, include plenty of calcium, iron, and healthy fats. Limit processed snacks and sugary drinks.",
            "Elderly nutrition should prioritize protein, calcium, and vitamin D. Soft, easy-to-digest meals are also key."
        ]
    }
            }
